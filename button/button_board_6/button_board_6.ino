...
const int potentiometer2 = 39;
int potentiometerVal2 = 0;
...
void loop() {
  ...
  potentiometerVal2 = analogRead(potentiometer2);
  ...
  if ((millis() - lastDebounceTime1) > debounceDelay) {
    ...
    Serial.println(potentiometerVal2);
     
     OSCMessage msg("/board6");
       msg.add(button1state);
       msg.add(potentiometerVal);
       msg.add(potentiometerVal2);
